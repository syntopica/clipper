  ...
  it('reports the state and the clip link the service returned', async () => {
    const fetchMock = answer({
      data: {
        ...
        state: 'ingested',
        clip_url: 'https://github.com/CristianDeluxe/brain-clips/tree/main/clips/processed/x',
      },
    })
    ...
    expect(await fetchClipStatus('https://example.com/a')).toStrictEqual({
      ...
      clipUrl: 'https://github.com/CristianDeluxe/brain-clips/tree/main/clips/processed/x',
    })
